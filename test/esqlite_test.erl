...
sqlite_version_test() ->
    ...
    ?assertEqual({row, {<<"3.51.1">>}}, esqlite3:step(Stmt)),
    ok.
...
sqlite_source_id_test() ->
    ...
    ?assertEqual({row,{<<"2025-11-28 17:28:25 281fc0e9afc38674b9b0991943b9e9d1e64c6cbdb133d35f6f5c87ff6af38a88">>}}, esqlite3:step(Stmt)),
    ok.
